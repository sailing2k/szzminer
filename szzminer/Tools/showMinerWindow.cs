...
{
    class showMinerWindow
    {
        EventHandler appIdleEvent = null;
        Control ParentCon = null;
        string strGUID = "";

        public showMinerWindow(Control C, string Titlestr)
        {
        ...
        public void EmbedProcess(Process app, Control control)
        {
            ...
            MoveWindow(app.MainWindowHandle, 0, 0, ParentCon.Width, ParentCon.Height, true);
        }
